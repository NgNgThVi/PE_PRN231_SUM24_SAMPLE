...
public partial class PePrn23fallB5Context : DbContext
{
    public PePrn23fallB5Context()
    {
    }

    public PePrn23fallB5Context(DbContextOptions<PePrn23fallB5Context> options)
        : base(options)
    {
    }
